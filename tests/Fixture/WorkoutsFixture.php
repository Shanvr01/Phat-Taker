...
class WorkoutsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'program_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'program_id' => ['type' => 'index', 'columns' => ['program_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'workouts_ibfk_1' => ['type' => 'foreign', 'columns' => ['program_id'], 'references' => ['programs', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
